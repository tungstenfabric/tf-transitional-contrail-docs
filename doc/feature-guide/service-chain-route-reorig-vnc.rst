...
In `Figure 91`_ , the service chain is inserted between the Left VN and the Right VN. The service chain contains one or more service instances to achieve a required network policy.
...
The relationships are shown in `Figure 92`_ .

.. _Figure 92: 

*Figure 92* : Route Aggregate Relationships
...
You can use the Contrail UI, **Configure > Networking > Routing > Create >Route Aggregate** screen to name the route aggregate object and identify the routes to aggregate. See `Figure 93`_ .

.. _Figure 93: 

*Figure 93* : Create Route Aggregate
...
Create a service instance with the route aggregate object linked to the aggregate left network subnet prefix in the right virtual network. See the example in `Figure 94`_ .

.. _Figure 94: 

*Figure 94* : Create Service Instance
