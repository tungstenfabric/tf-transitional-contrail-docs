...
Use the menu options available from the **Monitor** icon to configure and view the statistics you need for better understanding of the activities in your system. See `Figure 164`_ 

.. _Figure 164: 

*Figure 164* : Monitor Menu

.. figure:: s041506.gif

See `Table 37`_ for descriptions of the items available under each of the menu options from the **Monitor** icon.

.. _Table 37: 

*Table 37* : Monitor Menu Options
