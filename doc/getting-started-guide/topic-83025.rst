...
Select **Monitor > Infrastructure > Analytics Nodes** to view a summary of activities for the analytics nodes; see `Figure 145`_ . See `Table 56`_ for descriptions of the fields on the analytics summary.

.. _Figure 145: 

*Figure 145* : Analytics Nodes Summary
...
*Table 56* : Fields on Analytics Nodes Summary
...
Click the name of any analytics node displayed on the analytics summary to view the **Details** tab for that node. See `Figure 146`_ .

See `Table 57`_ for descriptions of the fields on this screen.

.. _Figure 146: 

*Figure 146* : Monitor Analytics Individual Node Details Tab
...
*Table 57* : Monitor Analytics Individual Node Details Tab Fields
...
The **Generators** tab displays information about the generators for an individual analytics node; see `Figure 147`_ . Click the expansion arrow next to any generator name to reveal more details. See `Table 58`_ for descriptions of the fields on the **Peers** tab screen.

.. _Figure 147: 

*Figure 147* : Individual Analytics Node—Generators Tab
...
*Table 58* : Monitor Analytics Individual Node Generators Tab Fields
...
The **QE Queries** tab displays the number of query expansion (QE) messages that are in the queue for this analytics node. See `Figure 148`_ .

See `Table 59`_ for descriptions of the fields on the **QE Queries** tab screen.

.. _Figure 148: 

*Figure 148* : Individual Analytics Node—QE QueriesTab
...
*Table 59* : Analytics Node QE Queries Tab Fields
...
Click the **Console** tab for an individual analytics node to display system logging information for a defined time period. See `Figure 149`_ . See `Table 60`_ for descriptions of the fields on the **Console** tab screen.

.. _Figure 149: 

*Figure 149* : Analytics Individual Node—Console Tab
...
*Table 60* : Monitor Analytics Individual Node Console Tab Fields
