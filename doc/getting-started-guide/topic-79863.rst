...
Click **Query > Logs** to access the **Query Logs** menu, where you can select **System Logs** to view system log activity, **Object Logs** to view object logs activity, and **Query Queue** to create custom queries of log activity; see `Figure 176`_ .

.. _Figure 176: 

*Figure 176* : Query > Logs
...
Click **Query > Logs > System Logs** to access the **Query System Logs** menu, where you can view system logs according to criteria that you determine. See `Figure 177`_ .

.. _Figure 177: 

*Figure 177* : Query > Logs > System Logs

.. figure:: s041894.gif

The query fields available on the **Query System Logs** screen are described in `Table 71`_ .

.. _Table 71: 


*Table 71* : Query System Logs Fields
...
#. At the **Query System Logs** screen, click in the **Where** field to access the **Where** query screen and enter information defining the location to query in the **Edit Where Clause** section and click **OK** ; see `Figure 178`_ .

   .. _Figure 178: 

   *Figure 178* : Edit Where Clause

   .. figure:: s041895.gif



#. The information you defined at the Where screen displays on the **Query System Logs** . Enter any more defining information needed; see `Figure 179`_ . When finished, click **Run Query** to display the results.

   .. _Figure 179: 

   *Figure 179* : Sample Query System Logs
...
Object logs allow you to search for logs associated with a particular object, for example, all logs for a specified virtual network. Object logs record information related to modifications made to objects, including creation, deletion, and other modifications; see `Figure 180`_ .

.. _Figure 180: 

*Figure 180* : Query > Logs > Object Logs

.. figure:: s041897.gif

The query fields available on the **Object Logs** screen are described in `Table 72`_ .

.. _Table 72: 


*Table 72* : Object Logs Query Fields
